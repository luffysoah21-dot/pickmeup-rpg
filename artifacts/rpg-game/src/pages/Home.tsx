      ...
      <div className="z-10 flex flex-col items-center">
        <div className="w-full flex justify-between items-start mb-8">
          <div className="flex flex-col">
            <span className="text-muted-foreground text-xs uppercase font-bold tracking-wider">Player</span>
          ...
          <div className="flex flex-col items-end">
            ...
            <span className="text-primary font-bold">Lvl {player?.level || 1}</span>
          </div>
        </div>
        ...
        {needsHero ? (
          <div className="text-center mb-6">
            <h2 className="text-2xl font-black text-accent mb-2 uppercase tracking-widest">No Hero Selected</h2>
            <p className="text-sm text-muted-foreground">You must summon a hero to begin your journey.</p>
          </div>
        ) : (
